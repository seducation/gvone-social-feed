...
import { TopicStoryShareDialog } from "@/components/TopicStoryShareDialog";
...
export default function Home() {
  ...
  const [topicStory, setTopicStory] = useState<{ url: string; title: string } | null>(null);
  ...
  return <div className="min-h-screen bg-[#f7f8fa] text-[#14161a]">
    ...
    {topicStory && <TopicStoryShareDialog open onOpenChange={(open) => { if (!open) setTopicStory(null); }} storyUrl={topicStory.url} storyTitle={topicStory.title} />}
